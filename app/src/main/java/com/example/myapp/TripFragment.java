...
public class TripFragment extends Fragment {
    ...
    TextView username,email,phone,dob,sex;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        phone = view.findViewById(R.id.textView20);
        dob = view.findViewById(R.id.textView18);
        sex = view.findViewById(R.id.textView19);
